...
// --- Map projection ----------------------------------------------------------
// Mercator projection centred on the Mediterranean basin, drawn into a
// 1200×600 SVG viewBox. The same projection is used both for plotting cities
// and for rendering Natural Earth land outlines (via d3-geo + topojson),
// so coastlines and city dots stay perfectly aligned.
const VIEW_W = 1200;
const VIEW_H = 600;
...
// Natural Earth 1:110m land mass — single merged polygon, no internal borders.
    ...
    <div className="bg-parchment">
      ...
      <div className="relative border border-ink/15 rounded overflow-hidden">
        ...
        >
          ...
          {/* Land mass — Natural Earth 1:110m, projected via d3-geo */}
          <path
            d={LAND_PATH}
            fill="#f5efe0"
            stroke="#1f1a13"
